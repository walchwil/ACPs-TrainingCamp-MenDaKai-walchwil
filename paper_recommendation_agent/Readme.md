...
**基于 arXiv官方库的论文爬取与数据清洗（整体Agent项目的前1/3）**
...
本项目从 arXiv 爬取计算机科学领域的论文，具体分类及配额如下：
...
**原因**：
	...
	3.前期数据清洗工作可以做出很好的效果。选择这三个分类可以为后续Agent提供高质量的科研数据基础。
...
开发过程远非一帆风顺。经历了多次从**请求被封**到**完美解析**曲折：
